...
input_path = '/home/neo/project/nova_mind/meta_network/omniglot/'
...
# print "Loading train..."
train_generator = OmniglotGenerator(data_file=input_path + 'train.npz',
									augment = True,
...
test_generator = OmniglotGenerator(data_file=input_path + 'test.npz',
									augment = False,
